...
function media_upload(button_class) {
    ...
    jQuery('body').on('click', button_class, function () {
        ...
        wp.media.editor.send.attachment = function (props, attachment) {
            ...
            if (_custom_media) {
                display_field.prev('img').remove();
                display_field.before('<img src="'+ attachment.url +'">');
...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            var checkbox = jQuery(this).find('.customizer-repeater-checkbox-control').is(':checked');
            var text2 = jQuery(this).find('.customizer-repeater-text2-control').val();
            var btnText = jQuery(this).find('.customizer-repeater-button-text-control').val();
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || btn_text !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '') {
                values.push({
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
                ...
                /*Remove value from checkbox field*/
                field.find('.customizer-repeater-checkbox-control').val('0');
                ...
                /*Remove image*/
                field.find('.custom-media-url').prev('img').remove();
    ...
    theme_conrols.on('change', '.customizer-repeater-checkbox-control', function () {
        customizer_repeater_refresh_general_control_values();
    });
